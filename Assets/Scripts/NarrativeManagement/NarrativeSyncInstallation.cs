...
public class NarrativeSyncInstallation : MonoBehaviour
{
    VisualEffect pointcloudvfx;
    NarrativeManagerInstallation narrativeManager;
    ...
    void Start()
    {
        ...
        narrativeManager = narrativeObject.GetComponent<NarrativeManagerInstallation>();
